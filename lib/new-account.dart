...
class _NewAccountState extends State<NewAccount> {
  ...
  void updateUser(
    String appName, String username, String password, String notes) async {    final id = Global.user[0]['_id'];
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      updateUser(appNameController.text, usernameController.text, passwordController.text, notesController.text);
                    },
                    child: Row(
